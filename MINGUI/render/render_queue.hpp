...
public:
    ...
    void add(const Point position, const Point glyphSize, const std::string_view string, const uint32_t color) {
        mainLayerTexts.emplace_back(position, glyphSize, string, color);
    }
